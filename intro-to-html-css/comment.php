...
if (isset($_POST['comSubmit'])){
    ...
    if($username && $email_pref === 'true' ){
        $link = "http://localhost:8080/Camagru/gallery.php";
        $mailbody = '
                        Hi '.$image.'

                        '.$username.' commented "'.$comment.',"on a picture you posted:
        ...
        mail("$email", "www.noreply@camagru.com - Comment Notification", $mailbody);
            ...
            if ($stmt->rowCount() == 1){
                ...
                header("location: gallery.php?Comment was Successful");
            }
    }
